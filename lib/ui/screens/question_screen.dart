...
class _QuestionScreenState extends State<QuestionScreen> {
  ...
  Future<void> _submitSession() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to start submission: $e')),
      );
    }
  }
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                const Icon(Icons.mic, size: 28, color: AppTheme.primaryPurple),
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    icon: Icon(interview.currentIndex < interview.questions.length - 1
                        ? Icons.arrow_forward
                        : Icons.check_circle_outline),
                    label: Text(interview.currentIndex < interview.questions.length - 1 ? 'Next' : 'Finish'),
                    onPressed: interview.currentIndex < interview.questions.length - 1 ? interview.next : _submitSession,
                    style: ElevatedButton.styleFrom(
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Card(
                              ...
                              shadowColor: AppTheme.primaryPurple.withOpacity(0.12),
                              child: Padding(
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 13,
                                        color: interview.hasRecording ? AppTheme.success : Colors.black45,
                      ...
                      Flexible(
                        ...
                        child: Column(
                          children: [
                            _buildRecorderCard(true), // keep your method
                            const SizedBox(height: 16),
